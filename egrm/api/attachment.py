...
def upload(issue_id=None, file_data=None, description=None):
	...
	try:
		...
		frappe.log_error(f"Error in upload_attachment: {e!s}")
...
def list(issue_id):
	...
	try:
		...
		frappe.log_error(f"Error in list_attachments: {e!s}")
		return {"status": "error", "message": str(e)}
...
def download(attachment_id):
	...
	try:
		...
		frappe.log_error(f"Error in download_attachment: {e!s}")
		return {"status": "error", "message": str(e)}
...
def save_file(file_data, issue_id):
	...
	try:
		...
		frappe.log_error(f"Error saving file: {e!s}")
		return None
