...
def has_permission(doc, ptype, user):
    ...
    try:
        ...
        user_project_assignments = frappe.get_all(
            ...
            filters={"user": user, "project": doc.project, "is_active": 1},
        ...
        for assignment in user_project_assignments:
            ...
            if role == "GRM Field Officer":
                ...
                if check_region_access(
                    user, doc.administrative_region, assignment.administrative_region
                ):
                    return True
...
def permission_query_conditions(user):
    ...
    try:
        ...
        if "System Manager" in frappe.get_roles(
            user
        ) or "GRM Administrator" in frappe.get_roles(user):
            return ""
        ...
        for assignment in user_projects:
            ...
            if role == "GRM Project Manager":
                ...
                categories = frappe.get_all(
                    "GRM Issue Category",
                    filters={"assigned_department": assignment.department},
                    pluck="name",
                )
