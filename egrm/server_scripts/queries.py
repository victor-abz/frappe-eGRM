...
def get_departments_by_projects(doctype, txt, searchfield, start, page_len, filters):
	...
	try:
		...
		frappe.log_error(f"Error getting departments by projects: {e!s}")
		return []
...
def get_status_by_project(doctype, txt, searchfield, start, page_len, filters):
	...
	try:
		...
		frappe.log_error(f"Error getting statuses by project: {e!s}")
		return []
...
def get_category_by_project(doctype, txt, searchfield, start, page_len, filters):
	...
	try:
		...
		frappe.log_error(f"Error getting categories by project: {e!s}")
		return []
...
def get_issue_type_by_project(doctype, txt, searchfield, start, page_len, filters):
	...
	try:
		...
		frappe.log_error(f"Error getting issue types by project: {e!s}")
		return []
...
def get_age_group_by_project(doctype, txt, searchfield, start, page_len, filters):
	...
	try:
		...
		frappe.log_error(f"Error getting age groups by project: {e!s}")
		return []
...
def get_citizen_group_by_project(doctype, txt, searchfield, start, page_len, filters):
	...
	try:
		...
		frappe.log_error(f"Error getting citizen groups by project: {e!s}")
		return []
...
def get_project_users(doctype, txt, searchfield, start, page_len, filters):
	...
	try:
		...
		frappe.log_error(f"Error getting project users: {e!s}")
		return []
...
def get_department_for_category(category):
	...
	try:
		...
		redirection = frappe.db.get_value("GRM Issue Category", category, "redirection_protocol")
		return {
		...
		frappe.log_error(f"Error getting department for category: {e!s}")
		return None
...
def get_least_loaded_user(department, project):
	...
	try:
		...
		frappe.log_error(f"Error getting least loaded user: {e!s}")
		return None
...
def get_open_statuses(project):
	...
	try:
		...
		frappe.log_error(f"Error getting open statuses: {e!s}")
		return []
...
def get_allowed_statuses(issue):
	...
	try:
		...
		frappe.log_error(f"Error getting allowed statuses: {e!s}")
		return []
...
def get_category_stats(category):
	...
	try:
		...
		# Count open issues
		open_count = (
			frappe.db.count("GRM Issue", {"category": category, "status": ["in", open_statuses]})
			if open_statuses
			else 0
		)
		...
		frappe.log_error(f"Error getting category stats: {e!s}")
