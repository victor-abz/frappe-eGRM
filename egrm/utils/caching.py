...
def get_cached_region_hierarchy(region_id):
	...
	if cached_data:
		try:
			...
			frappe.log_error(f"Error parsing cached region hierarchy: {e!s}")
	...
	try:
		...
		frappe.log_error(f"Error caching region hierarchy: {e!s}")
...
def get_cached_region_children(region_id):
	...
	if cached_data:
		try:
			...
			frappe.log_error(f"Error parsing cached region children: {e!s}")
	...
	try:
		...
		frappe.log_error(f"Error caching region children: {e!s}")
...
def get_cached_issue_statuses():
	...
	if cached_data:
		try:
			...
			frappe.log_error(f"Error parsing cached issue statuses: {e!s}")
	...
	try:
		...
		frappe.log_error(f"Error caching issue statuses: {e!s}")
...
def get_cached_categories(project_id=None):
	...
	if cached_data:
		try:
			...
			frappe.log_error(f"Error parsing cached categories: {e!s}")
	...
	try:
		...
		frappe.log_error(f"Error caching categories: {e!s}")
...
def get_cached_project(project_id):
	...
	if cached_data:
		try:
			...
			frappe.log_error(f"Error parsing cached project: {e!s}")
	...
	try:
		...
		frappe.log_error(f"Error caching project: {e!s}")
	...
	if region_id:
		...
		for key in cache_keys:
			try:
				...
				frappe.log_error(f"Error clearing region cache: {e!s}")
	else:
		...
		try:
			...
			frappe.log_error(f"Error clearing all region caches: {e!s}")
...
def clear_status_cache():
	...
	try:
		...
		frappe.log_error(f"Error clearing status cache: {e!s}")
...
def clear_category_cache(project_id=None):
	...
	if project_id:
		...
		try:
			...
			frappe.log_error(f"Error clearing category cache for project {project_id}: {e!s}")
	else:
		...
		try:
			...
			frappe.log_error(f"Error clearing all category caches: {e!s}")
...
def clear_project_cache(project_id=None):
	...
	if project_id:
		...
		try:
			...
			frappe.log_error(f"Error clearing project cache for {project_id}: {e!s}")
	else:
		...
		try:
			...
			frappe.log_error(f"Error clearing all project caches: {e!s}")
