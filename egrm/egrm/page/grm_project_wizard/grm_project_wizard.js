...
//   - GRMWizardStep9UsersList  (Phase C — implemented here)
//   - GRMWizardStep9UserAdd    (Phase D — placeholder div for now)
//   - GRMWizardStep9UserImport (Phase E — placeholder div for now)
//
...
class GRMWizardStep9Users {
    ...
    render() {
        ...
        // Composition: existing-users list + Add-users panel (Single-add
        // active in Phase D; CSV/Excel placeholder until Phase E).
        this.$body.html(`
        ...
        this.list_panel = new GRMWizardStep9UsersList($list_body, this.project, this.wizard);
    ...
    render_add_panel() {
        ...
        // Construct the Single-add subform once and reuse it on toggle.
        ...
        $section.find(".grm-step9-add-toggle button").on("click", (ev) => {
            ...
            if (mode === "single") {
                ...
                // Phase E will replace this placeholder with the bulk-import flow.
                $content.html(`
                  <div class="grm-step9-add-form grm-step9-add-bulk-stub">
                    <p class="text-muted">${__("CSV/Excel import — coming in Phase E.")}</p>
                  </div>
                `);
            }
        });
