...
class GRMWizardStep9Users {
    ...
    render() {
        ...
        // Composition: a panel for the existing-users list, then a stub
        // for the Add panel (Phase D + E will replace this).
        this.$body.html(`
            <div class="grm-step9-users-panel"></div>
            <div class="grm-step9-add-panel grm-step9-placeholder">
              <p class="text-muted">${__("Add / Import users — coming in the next iteration of this wizard step.")}</p>
            </div>
        `);
