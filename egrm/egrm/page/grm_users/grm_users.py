...
def list_assignments(
	...
	region_ids = {r["administrative_region"] for r in rows if r.get("administrative_region")}
	...
	for row in rows:
		...
		if row.get("administrative_region"):
			row["region_name"] = region_map.get(row["administrative_region"], row["administrative_region"])
