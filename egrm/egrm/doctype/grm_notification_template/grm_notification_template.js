					...
					fields: [
						{
							...
							fieldtype: "HTML",
							options:
								"<p>Preview with sample data:</p><ul><li><strong>Tracking Code:</strong> GRM-2025-001</li><li><strong>Status:</strong> Open</li><li><strong>Subject:</strong> Road Damage Complaint</li></ul>",
						},
					],
				});
				d.show();
