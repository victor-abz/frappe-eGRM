...
CSV_ROWS = [
    ...
    ("walker.alice@example.com",  "Alice",    "Walker",   "Female", "+250788000001", "Officer", "Kigali City", "Gasabo",     "Kacyiru"),
    ("walker.bruno@example.com",  "Bruno",    "Walker",   "Male",   "+250788000002", "Officer", "Kigali City", "Nyarugenge", "Nyamirambo"),
    ("walker.celia@example.com",  "Celia",    "Walker",   "Female", "+250788000003", "Officer", "Northern",    "Musanze",    "Cyuve"),
    ("walker.diego@example.com",  "Diego",    "Walker",   "Male",   "+250788000004", "Officer", "Western",    "Rubavu",     "Gisenyi"),
]
CSV_HEADERS = (
    "Email", "First Name", "Last Name", "Gender", "Phone",
    "Position", "Province", "District", "Sector",
)
...
def _write_csv() -> Path:
    f = tempfile.NamedTemporaryFile(
        "w", prefix="step9_walker_", suffix=".csv", delete=False, encoding="utf-8",
    )
